...
#以妈妈视角为例
normmap_path="C://Users//li000167//Documents//project//gaze_attention//normmap_detection//mother//" #normmap存储位置
DET_objectpath="C://Users//li000167//Documents//project//gaze_attention//object label//test//" # object
DET_headpath='C://Users//li000167//Documents//project//deepsort_tracking//youth//tracking//trackid_manual//result//extract//children//' #如果是妈妈就是对应的小孩的头的位置
...
for filename in os.listdir(normmap_path):              #listdir的参数是存储norm_hm文件夹的路径 #./test2 是out3_all的测试路径，之后改成对应比如out3_B000167
    ...
    for pklname in os.listdir(normmap_path+filename):       
        ...
        for line_head in F_headDET:#妈妈视角，所以是小孩的头对应的heatmap，id=13
...
heatmap_all.to_csv('./heatmap_motherview_basedonDET.csv',index=None)
